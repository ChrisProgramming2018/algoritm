...
class TestProgram(unittest.TestCase):
    ...
    def test_case_12(self):
        self.assertEqual(program.kadanesAlgorithm([8, 5, -9, 1, 3, -2, 3, 4, 7, 2, -18, 6, 3, 1, -5, 6, 20, -23, 15, 1, -3, 4]), 35)

    def test_case_13(self):
        self.assertEqual(program.kadanesAlgorithm([100, 8, 5, -9, 1, 3, -2, 3, 4, 7, 2, -18, 6, 3, 1, -5, 6, 20, -23, 15, 1, -3, 4]), 135)
