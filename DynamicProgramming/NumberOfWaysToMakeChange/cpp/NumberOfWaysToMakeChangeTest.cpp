...
TEST(NumberOfWaysToMakeChangeTest, NumberOfWaysToMakeChange2) {
  std::vector<int> vector1 {2, 3, 4, 7};
  std::vector<int> vector2 {5};
  std::vector<int> vector3 {2, 4};
  std::vector<int> vector4 {1, 5};
  ...
  std::vector<int> vector8 {1, 5, 10, 25};
  std::vector<int> vector9 {2, 3, 7};
  ASSERT_EQ(numberOfWaysToMakeChange2(0, vector1), 1);
  ASSERT_EQ(numberOfWaysToMakeChange2(9, vector2), 0);
  ASSERT_EQ(numberOfWaysToMakeChange2(7, vector3), 0);
  ASSERT_EQ(numberOfWaysToMakeChange2(6, vector4), 2);
  ASSERT_EQ(numberOfWaysToMakeChange2(4, vector5), 1);
  ASSERT_EQ(numberOfWaysToMakeChange2(5, vector6), 2);
  ASSERT_EQ(numberOfWaysToMakeChange2(10, vector7), 4);
  ASSERT_EQ(numberOfWaysToMakeChange2(25, vector8), 13);
  ASSERT_EQ(numberOfWaysToMakeChange2(12, vector9), 4);
}
